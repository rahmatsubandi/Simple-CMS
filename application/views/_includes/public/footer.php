        ...
        <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ml-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item"><a href="<?= base_url() ?>" target="_blank" class="link-secondary">Simple CMS</a></li>
                </ul>
            </div>
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        Copyright © <?= date('Y') ?>
                        &bullet;
                        Handcraft full <span class="text-danger">❤</span>
                        <a href="<?= base_url() ?>" class="link-secondary">Reza</a>.
                        All rights reserved.
                    </li>
                </ul>
            </div>
